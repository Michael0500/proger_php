...
- формы и фильтры;
- тесты;
- `AGENTS.md` и `CLAUDE.md`, если изменение значимое;
...
- `AGENTS.md` и `CLAUDE.md` - если изменение влияет на инструкции для агентных инструментов.

Документация должна описывать фактическое поведение системы, а не планируемое.
