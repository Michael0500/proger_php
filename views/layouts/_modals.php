        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <select id="entry-account-select2" style="width:100%"></select>
                    <div v-if="!editingEntry.account_id" style="font-size:11px;color:#ef4444;margin-top:4px">
                        <i class="fas fa-exclamation-circle me-1"></i>Выберите счёт из списка
                    </div>
                </div>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control"
                               ...
                               v-model="editingEntry.currency" placeholder="USD" maxlength="3">
                    </div>
                    <div class="col-md-3">
                ...
                <div class="form-section">
                    <div class="form-section-title">
                        ...
                        <span style="font-weight:400;color:#c4c9d6;text-transform:none;letter-spacing:0">— необязательно</span>
                    </div>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label">Instruction ID</label>
                            <input type="text" class="form-control" style="font-family:monospace;font-size:12.5px"
                ...
                <div class="mt-3">
                    ...
                    <input type="text" class="form-control" v-model="editingEntry.comment"
                           maxlength="40" placeholder="До 40 символов...">
                </div>
            </div>
            <div class="modal-footer">
                <button class="modal-btn cancel"     @click="closeEntryModal"><i class="fas fa-times"></i>Отмена</button>
